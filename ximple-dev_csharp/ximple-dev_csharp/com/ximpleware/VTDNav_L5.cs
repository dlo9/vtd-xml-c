...
namespace com.ximpleware
{
    public class VTDNav_L5 : com.ximpleware.VTDNav
    {
                    ...
                    switch (context[0])
                    {
                        ...
                        case 1:
                            if (l1Buffer.lower32At(l1index) != -1)
                            {
                                ...
                                l2lower = l1Buffer.lower32At(l1index);
                                tmp = l1index + 1;
                                while (tmp < l1Buffer.size_Renamed_Field)
                                {
                                ...
                                if (tmp == l1Buffer.size_Renamed_Field)
                                {
                                    l2upper = l2Buffer.size_Renamed_Field - 1;
                                }
                                index = context[1] + 1;
                        ...
                        case 2:
                            if (l2Buffer.lower32At(l2index) != -1)
                            {
                                ...
                                l3lower = l2Buffer.lower32At(l2index);
                                tmp = l2index + 1;
                                while (tmp < l2Buffer.size_Renamed_Field)
                                {
                                ...
                                if (tmp == l2Buffer.size_Renamed_Field)
                                {
                                    l3upper = l3Buffer.size_Renamed_Field - 1;
                                }
                                index = context[2] + 1;
                        ...
                        case 3:
                            if (l3Buffer.lower32At(l3index) != -1)
                            {
                                ...
                                l4lower = l3Buffer.lower32At(l3index);
                                tmp = l3index + 1;
                                while (tmp < l3Buffer.size_Renamed_Field)
                                {
                                ...
                                if (tmp == l3Buffer.size_Renamed_Field)
                                {
                                    l4upper = l4Buffer.size_Renamed_Field - 1;
                                }
                                index = context[3] + 1;
                        ...
                        case 4:
                            if (l4Buffer.lower32At(l4index) != -1)
                            {
                                ...
                                l5lower = l4Buffer.lower32At(l4index);
                                tmp = l4index + 1;
                                while (tmp < l4Buffer.size_Renamed_Field)
                                {
                                ...
                                if (tmp == l4Buffer.size_Renamed_Field)
                                {
                                    l5upper = l5Buffer.size_Renamed_Field - 1;
                                }
                                index = context[4] + 1;
                        ...
                        default:
                            ...
                            while (index < vtdBuffer.size_Renamed_Field)
                            {
                                long temp = vtdBuffer.longAt(index);
                                tokenType =
                ...
                case NEXT_SIBLING:
                    switch (context[0])
                    {
                        ...
                        case 0:
                            if (atTerminal)
                            {
                                ...
                                if (l1Buffer.size_Renamed_Field != 0)
                                {
                                    ...
                                    else if (l1index < l1Buffer.size_Renamed_Field - 1)
                                    { // whether lindex is the last entry is l1 buffer
                                        l1index++;
                                        if (tokenType == TOKEN_PI_NAME)
                                            index++;
                                        if (index <= l1Buffer.upper32At(l1index))
                        ...
                        case 1:
                            ...
                            {
                                if (l1index != l1Buffer.size_Renamed_Field - 1)
                                {
                                    // not the last one
                                    //rewind
                                    l1index++;
                        ...
                        case 3:
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    if (l2index != l2Buffer.size_Renamed_Field - 1 && l2index != l2upper)
                                    {
                        ...
                        case 4:
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    if (l3index != l3Buffer.size_Renamed_Field - 1 && l3index != l3upper)
                                    {
                        ...
                        case 5:
                            if (!atTerminal)
                            {
                                ...
                                else
                                {
                                    ...
                                    if (l4index != l4Buffer.size_Renamed_Field - 1 && l4index != l4upper)
                                    {
                        ...
                        default:
                            ...
                            {
                                long temp = vtdBuffer.longAt(index);
                                tokenType = (int)((MASK_TOKEN_TYPE & temp) >> 60) & 0xf;
        ...
        protected internal override bool toNode_PrevSibling()
        {
                        ...
                        else
                        {
                            ...
                            if (index > rootIndex)
                            {
                                ...
                                switch (tokenType)
                                {
                                    case TOKEN_PI_VAL:
                                        index--;
                                        goto case TOKEN_CHARACTER_DATA;
                                    case TOKEN_CHARACTER_DATA:
                                    case TOKEN_COMMENT:
                                    case TOKEN_CDATA_VAL:
        ...
        protected internal override bool toNode_LastChild()
        {
            ...
            switch (context[0])
            {
                ...
                case 0:
                    if (l1Buffer.size_Renamed_Field != 0)
                    {
                        lastEntry = l1Buffer.upper32At(l1Buffer.size_Renamed_Field - 1);
                        index = vtdSize - 1;
                            ...
                            else if (depth == 0)
                            {
                                ...
                                switch (tokenType)
                                {
                                    ...
                                    case TOKEN_CDATA_VAL:
                                        LN = index;
                                        atTerminal = true;
                                        l1index = l1Buffer.size_Renamed_Field - 1;
                                        return true;
                                    case TOKEN_PI_VAL:
                                        LN = index - 1;
                                        atTerminal = true;
            ...
            switch (depth)
            {
                ...
                case 0:
                    if (l1Buffer.size_Renamed_Field != 0)
                    {
                        ...
                        if (index > l1Buffer.upper32At(l1Buffer.size_Renamed_Field - 1))
                        {
                            l1index = l1Buffer.size_Renamed_Field - 1;
                            return;
                        }
                        ...
                        if (index > l1Buffer.upper32At(l1index))
                        {
                            while (l1index < l1Buffer.size_Renamed_Field - 1 && l1Buffer.upper32At(l1index) < index)
                            {
                                l1index++;
                            }
                            //l1index--;
                ...
                case 1:
                    if (l1Buffer.lower32At(l1index) != -1)
                    {
                        if (l2lower != l1Buffer.lower32At(l1index))
                        {
                            ...
                            l2upper = l2Buffer.size_Renamed_Field - 1;
                            int size = l1Buffer.size_Renamed_Field;
                            for (int i = l1index + 1; i < size; i++)
                            {
                                int temp = l1Buffer.lower32At(i);
                                if (temp != -1)
                ...
                case 2:
                    if (l2Buffer.lower32At(l2index) != -1)
                    {
                        if (l3lower != l2Buffer.lower32At(l2index))
                        {
                            ...
                            l3upper = l3Buffer.size_Renamed_Field - 1;
                            int size = l2Buffer.size_Renamed_Field;
                            for (int i = l2index + 1; i < size; i++)
                            {
                                int temp = l2Buffer.lower32At(i);
                                if (temp != -1)
                ...
                case 3:
                    if (l3Buffer.lower32At(l3index) != -1)
                    {
                        if (l4lower != l3Buffer.lower32At(l3index))
                        {
                            ...
                            l4upper = l4Buffer.size_Renamed_Field - 1;
                            int size = l3Buffer.size_Renamed_Field;
                            for (int i = l3index + 1; i < size; i++)
                            {
                                int temp = l3Buffer.lower32At(i);
                                if (temp != -1)
                ...
                case 4:
                    if (l4Buffer.lower32At(l4index) != -1)
                    {
                        if (l5lower != l4Buffer.lower32At(l4index))
                        {
                            ...
                            l5upper = l5Buffer.size_Renamed_Field - 1;
                            int size = l4Buffer.size_Renamed_Field;
                            for (int i = l4index + 1; i < size; i++)
                            {
                                int temp = l4Buffer.lower32At(i);
                                if (temp != -1)
        ...
        /// </summary>
        /// <returns></returns>
        public override bool verifyNodeCorrectness()
        {
            int i1, i2, tmp;
            if (atTerminal)
            {
                ...
                switch (context[0])
                {
                    ...
                    case 1:
                        if (LN > context[1])
                        {
                            ...
                            if (i1 != -1)
                            {
                                ...
                                tmp = l1index + 1;
                                i2 = l2Buffer.size_Renamed_Field - 1;
                                while (tmp < l1Buffer.size_Renamed_Field)
                                {
                                    if (l1Buffer.lower32At(tmp) != -1)
                                    {
                    ...
                    case 2:
                        if (LN > context[2] && context[2] > context[1])
                        {
                            ...
                            if (i1 != -1)
                            {
                                if (l3lower != i1)
                                    return false;
                                i2 = l3Buffer.size_Renamed_Field - 1;
                                tmp = l2index + 1;
                    ...
                    case 3:
                        if (LN > context[3] && context[3] > context[2] && context[2] > context[1])
                        {
                            ...
                            if (i1 != -1)
                            {
                                if (l4lower != i1)
                                    return false;
                                i2 = l4Buffer.size_Renamed_Field - 1;
                                tmp = l3index + 1;
                    ...
                    case 4:
                        if (LN > context[3] && context[3] > context[2] && context[2] > context[1])
                        {
                            ...
                            if (i1 != -1)
                            {
                                ...
                                i2 = l5Buffer.size_Renamed_Field - 1;
                                tmp = l4index + 1;
                    ...
                    default:
                        ...
                        if (context[0] == 5)
                        {
                            ...
                            if (l5index + 1 <= l5Buffer.size_Renamed_Field - 1)
                            {
        ...
        public override void dumpState()
        {
            ...
            Console.WriteLine("l2 upper ==>" + l2upper);
            Console.WriteLine("l3 index ==>" + l3index);
            Console.WriteLine("l3 lower ==>" + l3lower);
            Console.WriteLine("l3 upper ==>" + l3upper);
            Console.WriteLine("l4 index ==>" + l4index);
            Console.WriteLine("l4 lower ==>" + l4lower);
            Console.WriteLine("l4 upper ==>" + l4upper);
            Console.WriteLine("l5 index ==>" + l5index);
            Console.WriteLine("l5 lower ==>" + l5lower);
            Console.WriteLine("l5 upper ==>" + l5upper);
        }
    }
}
